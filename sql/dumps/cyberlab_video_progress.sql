...
CREATE TABLE `video_progress` (
  ...
  CONSTRAINT `video_progress_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `video_progress_ibfk_2` FOREIGN KEY (`video_id`) REFERENCES `videos` (`id`)
...
INSERT INTO `video_progress` VALUES (1,5,1,1,'2026-07-30 11:50:45');
